      ...
      <div className="overflow-x-auto min-h-100">
        <table className="w-full text-sm text-left">
          <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-[#112D4E] dark:text-gray-300 border-b border-(--color-muted) dark:border-[#3F72AF]/30">
            <tr>
              <th className="px-6 py-3 select-none w-16 text-center text-gray-500">
                No.
              </th>
              ...
              {columns.map((col) => {
                ...
                return (
                  <th
                    key={col}
                    className="px-6 py-3 select-none relative group"
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <div
                        className="flex-1 cursor-pointer hover:text-(--color-primary) transition-colors"
          ...
          <tbody>
            {paginatedData.map((row, idx) => (
              <tr
                key={idx}
                className="bg-white dark:bg-transparent border-b border-(--color-muted) dark:border-[#3F72AF]/30 hover:bg-gray-50 dark:hover:bg-[#3F72AF]/10 transition-colors"
              >
                <td className="px-6 py-4 whitespace-nowrap text-center font-medium text-gray-500 dark:text-gray-400">
                ...
                {columns.map((col) => (
                  <td
                    key={col}
                    className="px-6 py-4 whitespace-nowrap text-gray-700 dark:text-gray-200"
                  >
